 ...
 * @LastEditors: ldx
 * @LastEditTime: 2024-12-24 17:03:37
-->
<template>
  <div>
    <ExteriorShell>
...
const chart2Options = reactive(createOption(getChartOptions('网供负荷', 11982, 12000)))
const chart3Options = reactive(createOption(getChartOptions('上网负荷', 7973, 12000)))
const chart4Options = reactive(createOption(getChartOptions('网供负荷', 11927, 12000)))
